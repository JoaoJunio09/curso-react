	...
	return (
		<div className="flex items-center flex-col min-h-screen pb-7 px-2">
			...
			<form className="flex flex-col mt-8 mb-3 w-full max-w-xl">
				...
				<label className="text-white mt-2 mb-2.5">Url do Link</label>
				<Input
					type="url"
				...
				<section className="flex my- gap-5">
					<div className="flex gap-2">
						<label className="text-white mt-2 mb-2.5">Cor do Link</label>
						<input
							type="color"
					...
					<div className="flex gap-2">
						<label className="text-white mt-2 mb-2.5">Fundo do Link</label>
						<input
							type="color"
