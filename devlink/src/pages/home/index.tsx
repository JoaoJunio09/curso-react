...
export function Home() {
	return (
		<div className="flex flex-col w-full py-4 items-center justify-center">
			<h1 className="md:text-4xl text-3xl font-bold text-white mt-20">João Junio Dev</h1>
			...
			<main className="flex flex-col w-11/12 max-w-xl text-center">
				...
				<footer className="flex justify-center gap-3 my-4">
					<Social url="https://spc-azure.vercel.app">
						<FaLink size={35} color="#fff" />
					</Social>
					<Social url="https://youtube.com/sujeitoprogramador">
						<FaYoutube size={35} color="#fff" />
					</Social>
					<Social url="https://instagram.com/joaojunio_09">
